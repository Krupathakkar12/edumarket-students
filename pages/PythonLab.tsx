...
const PythonLab: React.FC = () => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (generated && generated.includes('error occurred')) {
        setError('Failed to generate code. The API might be experiencing issues. Please try again.');
      ...
      console.error('Python Lab Error:', err);
    ...
    <div className="container mx-auto px-4 py-12 max-w-7xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-3">
            {KAGGLE_DATASETS.map(ds => (
              <button
                ...
                className={`w-full text-left p-4 rounded-2xl border transition-all ${selectedDataset.id === ds.id
        ...
        <div className="lg:col-span-3 space-y-8">
          ...
          {/* Error Display */}
          {error && (
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-2xl p-6 animate-in fade-in">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-red-900 dark:text-red-200 mb-2">Code Generation Failed</h3>
                  ...
                  <div className="bg-red-100 dark:bg-red-900/40 p-3 rounded-lg text-xs text-red-900 dark:text-red-200">
                    ...
                    <ul className="list-disc list-inside space-y-1">
                      <li>Check if your VITE_GEMINI_API_KEY is correctly set in .env</li>
                      <li>Make sure you restarted the dev server after adding the API key</li>
                      <li>Verify your API key is valid at https://aistudio.google.com</li>
                    </ul>
                  </div>
                  <button
                    onClick={() => setError('')}
